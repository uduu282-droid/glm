 ...
 * 
 * Automatically captures fresh tokens, then generates video.
 * No need to run capture script separately!
 * 
 * Usage: node pixelbin_one_step.js "Your prompt here"
 */
...
async function oneStepGenerator() {
    console.log('='.repeat(70));
    console.log('🎬 PIXELBIN.IO - ONE-STEP VIDEO GENERATOR');
    console.log('='.repeat(70));
    ...
    try {
        ...
        console.log('\n' + '='.repeat(70));
        console.log('STEP 1/3: Capturing fresh authentication tokens...');
        console.log('='.repeat(70));
        ...
        console.log('\n' + '='.repeat(70));
        console.log('STEP 2/3: Generating video with captured tokens...');
        console.log('='.repeat(70));
        ...
        console.log('\n' + '='.repeat(70));
        console.log('STEP 3/3: Polling for video completion...');
        console.log('='.repeat(70));
...
// Run
const result = await oneStepGenerator();
if (!result.success) {
    console.log('\n❌ Failed:', result.error);
    process.exit(1);
}
