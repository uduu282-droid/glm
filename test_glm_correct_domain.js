...
// Test the GLM API at the correct domain
async function testGLMAPICorrect() {
    console.log('Testing GLM API at correct domain...\n');
    
    const baseUrl = 'https://api.featherlabs.online/v1'; // Using the correct domain
